...
| [6.03] |Interacting with the Object Superclass|Practice SC 9.3, 9.4, 9.9, 9.10, E 9.4;[WS 6.3]<br>[Poster 6.3]|9.3 up to “Interpreting Inheritance Code.” |
...
|:----------------|:----------------------------------------
| **Objectives**  | Students will replace superclass behavior by writing overriding methods in the subclass.<br>Students will write subclass methods that access superclass methods.
| **Assessments** | Students will complete Practice questions<br>Students will complete a worksheet.
| **In Class**    | Practice<br>SC 9.3–4,9–10<br>E 9.4<br>[WS 6.3]<br>[Poster 6.3]
