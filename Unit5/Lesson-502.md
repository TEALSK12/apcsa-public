...
> return(HP + attack + defense + specialAttack
>
...
public Pokemon(int hitpoints, int a) { in a complete version

> hp = hitpoints; you would include all stats
>
> attack = a;
...
1. Have students trade and error-check each other’s papers. Error-checking partners should write their name on the sheets to share credit for the work.
