...
> a. This should look pretty familiar to students, but have them point out to you the recursive case (input.nextLine()) to review.
>
> b. Point out to students the new feature on your model that holds the local variable line. Ask students what they think this represents? (It is a place in the computer’s memory that stores the variable line.)
>
> c. Ask students to narrate what happens when we call the reverse method.
>
> d. Write the “this” variable on the slip of paper, and ask students what happens next. The method will get called again—but because recursion works differently than iterative code, we don’t just run through the method again like with a loop.
>
> e. Take out the second copy of the reverse method, and place it over the first paper, as indicated in the textbook. Have students walk you through the method again and tell you what local variable will get written in the storage space at the bottom of the paper (“is”).
>
> f. Repeat these steps until you have reached the base case (the fifth sheet of paper). Ask students what the local variable is, and discuss what happens when there is no word left to reverse. (The input.hasNextLine() returns false, so that method terminates.)
>
> g. Now remove that fifth card from the pile, revealing the fourth copy of the method again. Let students know that Java returns to where it was before it executed the call that just terminated.
>
> i. Ask students what happens next. (We print the line “no?” and terminate.) Write this output on the board so students can keep track of the output.
>
> ii. This means that Java now goes to the place where it was before it terminated this call. Ask students what you should do now in your modeling of this recursive method. (Take off this card, and reveal the third method card.)
>
> h. Continue in this way until you have returned to the first card.
>
> i. If you need to repeat sections of this demo, do so until you feel that 50% of your class understands the process. At this point, students should be able to help each other learn the concepts during their activity.
...
a. Where the base case is, and when the base case occurs.

b. Where the recursive case is.

c. What causes the method to advance to the next round of recursion.

d. What causes the method to terminate.

e. Where Java returns to after a method has terminated.

f. What the output is.
...
2. Invite your class to create the dragon curve in pseudocode, they should notice that the figure (they don’t know how to draw) rotates 90 degrees around its near point.
