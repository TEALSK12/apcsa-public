...
> if (x == 0) {
>
> System.out.println(); this is the base case: “write 0
>
> } else { stars” needs no additional method
>
> System.out.println(“\*”);
>
> writeStars(x – 1); this is the recursive case: write
>
> } one star, then write however many
...
**Predict-the-Output Questions (con’t)**
