...
> <img src="Unit6/media/image1.png" width="96" height="36" />
>
> <img src="Unit6/media/image1.png" width="540" height="204" />
>
> <img src="Unit6/media/image1.png" width="96" height="36" />
>
...
> public class Bacon extends Pork implements Salty, Aromatic,
>
> + Greasy, Edible {
...
return amountInKg \* CALORIES\_PER\_KG\_OF\_BACON;
...
a. Subclasses: Red, Orange, Yellow, Green, Blue

> Interface: color
>
> Sample Methods: double wavelengthInNm, Boolean isPrimaryColor

b. Subclasses: Wood, Brick, Adobe, Stone, Canvas

> Interface: buildingMaterial
>
> Sample Methods: String movableHousing, double costPerLb

c. Subclasses: Boeing 747, Pheasant, PaperAirplane, Cannonball
...
> a. Students should define classes to implement as many combinations of interfaces as possible.
>
> b. Students must include at least 1 method for each interface.
>
> c. Each class has to implement the interface methods and include a constructor.

3. The team with the most combinations of interfaces at the end of the time limit (~20 minutes) win the competition.

Whole Group Review & Competition Judging/Award \[15 minutes\]
-------------------------------------------------------------

1. Leave time to have groups share their interfaces with the rest of the class during whole group discussion. Pay attention to any particularly creative or wacky examples that students come up with.
